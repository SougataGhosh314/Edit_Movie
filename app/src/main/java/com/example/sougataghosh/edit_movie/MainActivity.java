package com.example.sougataghosh.edit_movie;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViews();
        TooltipCompat.setTooltipText(addImg, "ADD IMAGE");
        getReferences();
...
//                                        newMovie.child("trailer").setValue(trailer);
                        ...
                        Toast.makeText(MainActivity.this, "Must add something to each field!!!", Toast.LENGTH_SHORT).show();
                    }
                }
                else {
                    Toast.makeText(MainActivity.this, "Invalid date!", Toast.LENGTH_SHORT).show();
